...
public class DatabaseElements extends AndroidTestBase {
	...
	public static MobileElement description(int rowCount,int column) {
		return driver.findElement(By.xpath("/hiera/hierrchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.ScrollView/android.widget.TableLayout/android.widget.TableRow["+rowCount+"]/android.widget.EditText["+column+"])"));
	}
	
	public static MobileElement amount(int rowCount,int column) {
		return driver.findElement(By.xpath("/hiera/hierrchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.ScrollView/android.widget.TableLayout/android.widget.TableRow["+rowCount+"]/android.widget.EditText["+column+"])"));
	}
}
