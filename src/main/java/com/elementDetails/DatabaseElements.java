...
public class DatabaseElements extends AndroidTestBase {
	public static MobileElement optionSelect() {
		return (MobileElement) driver.findElement(By.id("com.myapp.finance:id/spinner"));
	}
	
	public static MobileElement option_Expense() {
		//return driver.findElement(By.xpath("//android.widget.CheckedTextView[@index='1']"));
		return (MobileElement) driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[2]"));
	}
	
	public static MobileElement option_Income() {
		return (MobileElement) driver.findElement(By.xpath("//android.widget.CheckedTextView[@index='2']"));
	...
	public static MobileElement addRow() {
		return (MobileElement) driver.findElement(By.id("com.myapp.finance:id/add"));
	}
	
	public static MobileElement deleteRow() {
		return (MobileElement) driver.findElement(By.id("com.myapp.finance:id/delete"));
	}
	
	public static MobileElement saveData() {
		return (MobileElement) driver.findElement(By.id("com.myapp.finance:id/ins"));
	}
	
	public static MobileElement displayData() {
		return (MobileElement) driver.findElement(By.id("com.myapp.finance:id/ret"));
	}
	
	public static MobileElement description(int row,int column) {
		return (MobileElement) driver.findElement(By.xpath("//android.widget.TableRow[@index='"+row+"']/android.widget.EditText[@index='"+column+"']"));
